...
# Configure these in .env on the server (cPanel -> Email Accounts -> SMTP details).
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='SCHONES HEIM BUILDERS <no-reply@schones-heim-builders.co.ke>')
